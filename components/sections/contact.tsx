          ...
          >
            ...
            <div className="p-6 bg-muted rounded-xl">
              ...
              <p className="text-muted-foreground mb-4">
                I'm currently available for freelance work and full-time opportunities. My typical response time is
                within 24 hours.
              </p>
            ...
            <div className="mt-8">
              <Button size="lg" className="bg-primary hover:bg-primary/90 w-full" asChild>
                <Link href="https://cal.com/tushar-agarwal-mde3n6/15min" target="_blank" rel="noopener noreferrer">
